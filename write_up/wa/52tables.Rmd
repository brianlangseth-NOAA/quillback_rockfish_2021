...
mod_params[model$parameters$Label=="NatM_p_1_Fem_GP_1","Pr_SD"] = 0.438 #update for model 1100
...
<!-- tab:timeseries -->
```{r, results = 'asis'}
timeseries = read.csv(file.path("C:/Users/Brian.Langseth/Desktop/wa/11_0_0_postSSC_base", "tables", "TimeSeries.csv"))
