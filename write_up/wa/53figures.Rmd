...
```{r, echo=FALSE, results='asis'}
sss_loc = "L:/Assessments/CurrentAssessments/DataModerate_2021/Quillback_Rockfish/models/SSS_inputs"

add_figure(
filein = file.path(sss_loc, "WA_Quillback_SSS_57_2020/plots/SSS_57_Priors.png"), 
caption = "Prior distributions for parameter input for SSS where fraction unfished was assumed to be 57 percent",
label = "sss-prior-57")
```
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "WA_Quillback_SSS_40_2020/plots/SSS_40_quants.png"), 
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "WA_Quillback_SSS_40_2020/plots/SSS_40_Priors.png"), 
caption = "Prior distributions for parameter input for SSS where fraction unfished was assumed to be 40 percent",
label = "sss-prior-40")
```
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "WA_Quillback_SSS_57_2020/plots/SSS_57_quants.png"), 
