...
```{r, echo=FALSE, results='asis'}
sss_loc = "L:/Assessments/CurrentAssessments/DataModerate_2021/Quillback_Rockfish/models/WA_quillback_SSS_SSLOprior/plots"

add_figure(
filein = file.path(sss_loc, "WA_10_0_0_base_Priors.png"), 
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sss_loc, "WA_10_0_0_base_quants.png"), 
