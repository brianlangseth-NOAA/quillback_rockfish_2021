...
png(filename = file.path(getwd(), "comprare_recruitments.png"), width = 6, height = 6, units = "in", res = 300)
...
png(filename = file.path(getwd(), "comprare_selectivity.png"), width = 8, height = 6, units = "in", res = 300)
