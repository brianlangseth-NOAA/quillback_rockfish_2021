...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_CA_Commercial.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_CA_Recreational.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lenfit_data_weighting_TA1.8_CA_Commercial.png"), 
caption = "Model estimated mean length in cm (blue line) overlaid on mean length of commercial lengths (gray circles) with 95 percent confidence intervals (thick bars) based on current samples sizes. The thin bars indicate the confidence interval if Francis weighting were used instead",
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lenfit_data_weighting_TA1.8_CA_Recreational.png"), 
caption = "Model estimated mean length in cm (blue line) overlaid on mean length for recreational lengths (gray circles) with 95 percent confidence intervals (thick bars) based on current samples sizes. The thin bars indicate the confidence interval if Francis weighting were used instead",
...
sens_wd = file.path("C:/Users/Brian.Langseth/Desktop/ca", "sensitivities")
...
alt_caption = "Multi-panel density plot showing overlaid length distributions from two separate datasets. Each panel represents a separate year")
```

```{r, echo=FALSE, results='asis'}
review_sens_wd = file.path("C:/Users/Brian.Langseth/Desktop/ca", "write_up", "figures")
nm = "All_review_sensitivities_compare2_spawnbio_uncertainty.png"
add_figure(
filein = file.path(review_sens_wd, nm),
caption = "Change in estimated spawning output by additional sensitivity requests during model reviews",
label = 'review-sens-ssb',
alt_caption = "Line plot showing different trajectories of spawning output by year")
```

```{r, echo=FALSE, results='asis'}
nm = "All_review_sensitivities_compare4_Bratio_uncertainty.png"
add_figure(
filein = file.path(review_sens_wd, nm),
caption = "Change in estimated fraction unfished by additional sensitivity requests during model reviews",
label = 'review-sens-depl',
alt_caption = "Line plot showing different trajectories of fraction of unfished by year")
```

```{r, echo=FALSE, results='asis'}
nm = "All_review_sensitivities_compare12_recdevs_uncertainty.png"
add_figure(
filein = file.path(review_sens_wd, nm),
caption = "Change in estimated annual recruitment deviation by additional sensitivity requests during model reviews",
label = 'review-sens-recdev',
alt_caption = "Whisker plot showing different time series of estimated mean and 95 percent confidence intervals of log-recruitment deviations each year")
```

```{r, results = 'asis', echo = FALSE}
add_figure(
filein = file.path("L:\\Assessments\\CurrentAssessments\\DataModerate_2021\\Quillback_Rockfish\\data", "mopup_data", "comb_LA_data.png"), 
...
label = 'review-length-age',
alt_caption = "Dot plot showing new length-at-age data overlaid onto the larger set of length-at-age data used in the model")
```
