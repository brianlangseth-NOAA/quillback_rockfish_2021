...
\clearpage
## Appendix C: Comparison between the approved stock synthesis base case model and the stock synthesis model with dome-shaped selectivity and blocks in 2001.{#append_b}
