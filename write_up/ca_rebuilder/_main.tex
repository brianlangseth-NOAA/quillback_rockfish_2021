...
\hypersetup{
  pdftitle={DRAFT (post mopup version) Rebuilding analysis for quillback rockfish (Sebastes maliger) in U.S. waters off the coast of California based on the 2021 stock assessment},
  pdflang={en},
  hidelinks,
...
\vspace{1.5cm}
{\Large\textbf\newline{DRAFT (post mopup version) Rebuilding analysis for quillback rockfish (\emph{Sebastes maliger}) in U.S. waters off the coast of California based on the 2021 stock assessment}}
\vfill
by\\
