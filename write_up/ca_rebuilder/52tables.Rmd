...
quants = c(round(reb[[1]]$sb0,2), 
		   ...
		   reb[[1]]$tmin + reb[[1]]$recovery_spec[4], #I THINK THIS SHOULD BE RECOVERY_SPEC[3] because zero catch rebuild is 17 yet tmin is 19 so the two years of fixed catches from 2021 to 2023 are included in tmin already 
		   reb[[1]]$mean_gen, 
		   reb[[1]]$tmax, 
		   "TBD",
		   "TBD",
