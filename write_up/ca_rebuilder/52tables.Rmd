...
out[,7] = round(reb[[2]]$acl_matrix[1:47, 7],2) #Set the Tmid run to be from the no-ABC-cap run
table_format(x = out,
...
out[,7] = round(reb[[2]]$ofl_matrix[1:47, 7],2) #Set the Tmid run to be from the no-ABC-cap run
table_format(x = out,
