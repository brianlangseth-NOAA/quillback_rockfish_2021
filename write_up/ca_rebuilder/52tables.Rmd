...
<!-- <!-- Base rebuilder when no-ABC cap-->
<!-- ```{r, results = 'asis'} -->
<!-- # Rebuilding Reference Points Table -->
...
<!-- col_names = c("", colnames(out)[-1]) -->
<!-- table_format(x = out, -->
<!--              caption = "BASE - NO CAP. Results of rebuilding alternatives based on alternative SPR targets for 50 percent probability of recovery based on the assumed removals for 2021-22 when catches are not constrained by the ABC", -->
...
col_names[2] = paste0("*",col_names[2])
table_format(x = out,
             caption = "SENS - Results of rebuilding sensitivity based on alternative SPR targets for 50 percent probability of recovery based on the assumed removals for 2021-22. Rebuilding sensitivity blocks selectivity in 2001 and allows dome-shaped selectivity. The asterisk (*) indicates alternatives that could only be achieved when allowing catches to not be limited by the ABC",
...
<!-- col_names = c("", colnames(out)[-1]) -->
<!-- table_format(x = out, -->
<!--              caption = "SENS - NO CAP. Results of rebuilding sensitivity based on alternative SPR targets for 50 percent probability of recovery based on the assumed removals for 2021-22 when catches are not constrained by the ABC. Rebuilding sensitivity blocks selectivity in 2001 and allows dome-shaped selectivity", -->
<!--              label = "reb-options-noABCmax", -->
<!--              align = 'l', -->
<!--              landscape = TRUE, -->
<!--              col_names = col_names) -->
