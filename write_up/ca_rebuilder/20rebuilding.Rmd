...
At its September 2023 meeting, the Council set the value for total removals in 2024 to be `r round(reb_alt[[1]]$acl_matrix[2,2],2)` mt. The above rebuilding strategies were rerun using the new Council provided value for total removals in 2024 and Tables and Figures for the new analyses are provided in [Appendix B](#append_b). 
