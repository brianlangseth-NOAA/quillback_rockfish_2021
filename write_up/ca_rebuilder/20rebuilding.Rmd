...
All of the above rebuilding strategies were conducted assuming removals of `r round(reb[[1]]$acl_matrix[1,2],2)` mt in 2021 and `r round(reb[[1]]$acl_matrix[2,2],2)` mt in 2022 as recommended by the GMT. 
