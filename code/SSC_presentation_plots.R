...
#ca_len$Source = factor(nca_len$Source, levels = c( "Recreational", "Commercial"))
...
legend("topleft", c("Base model", "Est CVL2"), 
       col = c(rich.colors.short(14)[1],rich.colors.short(14)[7]), 
       pch = c(1,7), lty = 1, lwd = 2, bty = "n")
dev.off()
...
legend("topleft", c("Base model", "Est CVL2", "Est M"), 
       col = c(rich.colors.short(14)[1],rich.colors.short(14)[7],rich.colors.short(14)[8]), 
